...
-- Date        : Fri Jul 27 16:21:42 2018
-- Host        : DESKTOP-BCGMA0H running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               D:/intel_project/AX7015/new/05_bram_test/bram_intr.srcs/sources_1/bd/top/ip/top_pl_ram_ctrl_0_0/top_pl_ram_ctrl_0_0_sim_netlist.vhdl
...
entity top_pl_ram_ctrl_0_0_ram_read_write is
  port (
    en : out STD_LOGIC;
    ...
    \addr[31]\ : out STD_LOGIC_VECTOR ( 31 downto 0 );
  ...
  attribute ORIG_REF_NAME of top_pl_ram_ctrl_0_0_ram_read_write : entity is "ram_read_write";
end top_pl_ram_ctrl_0_0_ram_read_write;

architecture STRUCTURE of top_pl_ram_ctrl_0_0_ram_read_write is
  ...
  signal \addr0_carry__3_n_4\ : STD_LOGIC;
  signal \addr0_carry__3_n_5\ : STD_LOGIC;
  signal \addr0_carry__3_n_6\ : STD_LOGIC;
  signal \addr0_carry__3_n_7\ : STD_LOGIC;
  ...
  signal \addr0_carry__4_n_4\ : STD_LOGIC;
  signal \addr0_carry__4_n_5\ : STD_LOGIC;
  signal \addr0_carry__4_n_6\ : STD_LOGIC;
  signal \addr0_carry__4_n_7\ : STD_LOGIC;
  ...
  signal \addr0_carry__5_n_4\ : STD_LOGIC;
  signal \addr0_carry__5_n_5\ : STD_LOGIC;
  signal \addr0_carry__5_n_6\ : STD_LOGIC;
  signal \addr0_carry__5_n_7\ : STD_LOGIC;
  signal \addr0_carry__6_n_2\ : STD_LOGIC;
  signal \addr0_carry__6_n_3\ : STD_LOGIC;
  signal \addr0_carry__6_n_5\ : STD_LOGIC;
  signal \addr0_carry__6_n_6\ : STD_LOGIC;
  signal \addr0_carry__6_n_7\ : STD_LOGIC;
  ...
  signal \^addr[31]\ : STD_LOGIC_VECTOR ( 31 downto 0 );
...
begin
  ...
  \addr[31]\(31 downto 0) <= \^addr[31]\(31 downto 0);
  en <= \^en\;
...
addr0_carry: unisim.vcomponents.CARRY4
     port map (
      ...
      O(1) => addr0_carry_n_6,
      O(0) => addr0_carry_n_7,
      S(3 downto 2) => \^addr[31]\(4 downto 3),
...
\addr0_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 0) => \^addr[31]\(8 downto 5)
    );
\addr0_carry__1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 0) => \^addr[31]\(12 downto 9)
    );
...
\addr0_carry__3\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3) => \addr0_carry__3_n_4\,
      O(2) => \addr0_carry__3_n_5\,
      O(1) => \addr0_carry__3_n_6\,
      O(0) => \addr0_carry__3_n_7\,
      S(3 downto 0) => \^addr[31]\(20 downto 17)
    );
\addr0_carry__4\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3) => \addr0_carry__4_n_4\,
      O(2) => \addr0_carry__4_n_5\,
      O(1) => \addr0_carry__4_n_6\,
      O(0) => \addr0_carry__4_n_7\,
      S(3 downto 0) => \^addr[31]\(24 downto 21)
    );
\addr0_carry__5\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3) => \addr0_carry__5_n_4\,
      O(2) => \addr0_carry__5_n_5\,
      O(1) => \addr0_carry__5_n_6\,
      O(0) => \addr0_carry__5_n_7\,
      S(3 downto 0) => \^addr[31]\(28 downto 25)
    );
\addr0_carry__6\: unisim.vcomponents.CARRY4
     port map (
      ...
      O(2) => \addr0_carry__6_n_5\,
      O(1) => \addr0_carry__6_n_6\,
      O(0) => \addr0_carry__6_n_7\,
      S(3) => '0',
      S(2 downto 0) => \^addr[31]\(31 downto 29)
    );
...
\state1_inferred__0/i__carry\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '1',
      DI(3 downto 0) => \^addr[31]\(3 downto 0),
...
\state1_inferred__0/i__carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 0) => \^addr[31]\(7 downto 4),
...
\state1_inferred__0/i__carry__1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 0) => \^addr[31]\(11 downto 8),
...
\state1_inferred__0/i__carry__2\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 0) => \^addr[31]\(15 downto 12),
...
\state1_inferred__0/i__carry__3\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 0) => \^addr[31]\(19 downto 16),
...
\state1_inferred__0/i__carry__4\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 0) => \^addr[31]\(23 downto 20),
...
\state1_inferred__0/i__carry__5\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 0) => \^addr[31]\(27 downto 24),
...
\state1_inferred__0/i__carry__6\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => '0',
      DI(2 downto 0) => \^addr[31]\(30 downto 28),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity top_pl_ram_ctrl_0_0_pl_ram_ctrl_v2_0_S00_AXI is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of top_pl_ram_ctrl_0_0_pl_ram_ctrl_v2_0_S00_AXI : entity is "pl_ram_ctrl_v2_0_S00_AXI";
end top_pl_ram_ctrl_0_0_pl_ram_ctrl_v2_0_S00_AXI;

architecture STRUCTURE of top_pl_ram_ctrl_0_0_pl_ram_ctrl_v2_0_S00_AXI is
  ...
  signal ram_inst_n_1 : STD_LOGIC;
  signal ram_inst_n_4 : STD_LOGIC;
...
ram_inst: entity work.top_pl_ram_ctrl_0_0_ram_read_write
     port map (
      \FSM_sequential_state_reg[2]_0\ => ram_inst_n_1,
      Q(0) => \slv_reg0_reg_n_0_[0]\,
      SR(0) => ram_inst_n_4,
      \addr[31]\(31 downto 0) => addr(31 downto 0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity top_pl_ram_ctrl_0_0_pl_ram_ctrl_v2_0 is
  port (
    S_AXI_WREADY : out STD_LOGIC;
    S_AXI_AWREADY : out STD_LOGIC;
    S_AXI_ARREADY : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of top_pl_ram_ctrl_0_0_pl_ram_ctrl_v2_0 : entity is "pl_ram_ctrl_v2_0";
end top_pl_ram_ctrl_0_0_pl_ram_ctrl_v2_0;

architecture STRUCTURE of top_pl_ram_ctrl_0_0_pl_ram_ctrl_v2_0 is
begin
pl_ram_ctrl_v2_0_S00_AXI_inst: entity work.top_pl_ram_ctrl_0_0_pl_ram_ctrl_v2_0_S00_AXI
     port map (
      S_AXI_ARREADY => S_AXI_ARREADY,
      S_AXI_AWREADY => S_AXI_AWREADY,
      S_AXI_WREADY => S_AXI_WREADY,
...
entity top_pl_ram_ctrl_0_0 is
  ...
  attribute NotValidForBitStream of top_pl_ram_ctrl_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of top_pl_ram_ctrl_0_0 : entity is "top_pl_ram_ctrl_0_0,pl_ram_ctrl_v2_0,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of top_pl_ram_ctrl_0_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of top_pl_ram_ctrl_0_0 : entity is "pl_ram_ctrl_v2_0,Vivado 2017.4";
end top_pl_ram_ctrl_0_0;

architecture STRUCTURE of top_pl_ram_ctrl_0_0 is
...
inst: entity work.top_pl_ram_ctrl_0_0_pl_ram_ctrl_v2_0
     port map (
